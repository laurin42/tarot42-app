...
export default function IchStackNavigator() {
  ...
  console.log(
    "[(onboarding)/_layout.tsx] Rendering. isSessionLoading:",
    isSessionLoading,
    "sessionData (raw):",
  ...
  if (typeof sessionData === "object" && sessionData !== null) {
    console.log(
      "[(onboarding)/_layout.tsx] sessionData (stringified):",
      JSON.stringify(sessionData)
    );
  } else {
    console.log(
      "[(onboarding)/_layout.tsx] sessionData is not an object or is null/undefined:",
      sessionData
    );
  }
  ...
  if (isSessionLoading) {
    console.log(
      "[(onboarding)/_layout.tsx] Condition: isSessionLoading is TRUE. Showing loading indicator."
    );
    return (
  ...
  console.log(
    "[(onboarding)/_layout.tsx] Condition: isSessionLoading is FALSE."
  );

  if (!sessionData) {
    // Check if sessionData object itself is null/undefined
    console.log(
      "[(onboarding)/_layout.tsx] Condition: !sessionData is TRUE (sessionData is null or undefined). Redirecting to sign-in."
    );
  ...
  console.log(
    "[(onboarding)/_layout.tsx] Condition: sessionData is TRUTHY. Value (stringified):",
    JSON.stringify(sessionData)
  );
  ...
  if (!sessionData.user) {
    ...
    console.log(
      "[(onboarding)/_layout.tsx] Condition: !sessionData.user is TRUE (user object missing in sessionData). Redirecting to sign-in."
    );
    return <Redirect href="/(auth)/sign-in" />;
  }
  ...
  console.log(
    "[(onboarding)/_layout.tsx] Conditions met: Session and user are valid. Rendering Stack."
  );
  return (
    <Stack>
      <Stack.Screen
